				...
				void Standard::SubSave(State::Saver& state) const
				{
...

					{
						const byte data[35] =
						{
							...
							static_cast<byte>(regs.ctrl[2]),
							static_cast<byte>(regs.ctrl[3]),
							static_cast<byte>(regs.mul[0]),
							static_cast<byte>(regs.mul[1]),
							static_cast<byte>(regs.tmp),
							static_cast<byte>(banks.prg[0]),
							static_cast<byte>(banks.prg[1]),
							static_cast<byte>(banks.prg[2]),
							static_cast<byte>(banks.prg[3]),
							static_cast<byte>(banks.chr[0] & 0xFF),
							static_cast<byte>(banks.chr[0] >> 8),
							static_cast<byte>(banks.chr[1] & 0xFF),
							static_cast<byte>(banks.chr[1] >> 8),
							static_cast<byte>(banks.chr[2] & 0xFF),
							static_cast<byte>(banks.chr[2] >> 8),
							static_cast<byte>(banks.chr[3] & 0xFF),
							static_cast<byte>(banks.chr[3] >> 8),
							static_cast<byte>(banks.chr[4] & 0xFF),
							static_cast<byte>(banks.chr[4] >> 8),
							static_cast<byte>(banks.chr[5] & 0xFF),
							static_cast<byte>(banks.chr[5] >> 8),
							static_cast<byte>(banks.chr[6] & 0xFF),
							static_cast<byte>(banks.chr[6] >> 8),
							static_cast<byte>(banks.chr[7] & 0xFF),
							static_cast<byte>(banks.chr[7] >> 8),
							static_cast<byte>(banks.nmt[0] & 0xFF),
							static_cast<byte>(banks.nmt[0] >> 8),
							static_cast<byte>(banks.nmt[1] & 0xFF),
							static_cast<byte>(banks.nmt[1] >> 8),
							static_cast<byte>(banks.nmt[2] & 0xFF),
							static_cast<byte>(banks.nmt[2] >> 8),
							static_cast<byte>(banks.nmt[3] & 0xFF),
							static_cast<byte>(banks.nmt[3] >> 8)
						};
...

					{
						const byte data[5] =
						{
							static_cast<byte>(irq.enabled != 0),
							static_cast<byte>(irq.mode),
							static_cast<byte>(irq.prescaler & 0xFF),
							static_cast<byte>(irq.count),
							static_cast<byte>(irq.flip)
						};
